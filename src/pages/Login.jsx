...
export default function Login() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      await login(form)
    // Redirige a la pag en la que estaba antes de loguearse, si no a la pag principal
        ...
        <div className="container" style={{ maxWidth: 520 }}>
          ...
          <form className="form" onSubmit={onSubmit}>
            ...
            <div style={{ textAlign: "center", marginTop: "1rem" }}>
              <Link to="/forgot-password" style={{ fontSize: "0.9rem", color: "#0066cc", textDecoration: "none" }}>
