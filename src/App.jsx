          ...
          <RepairOrdersProvider>
            <RepairsProvider>
              <Routes>
                ...
                {/* Admin */}
                <Route path="/admin/dashboard" element={<AdminRoute auth={auth}><Dashboard /></AdminRoute>} />
                <Route path="/admin/orders" element={<AdminRoute auth={auth}><Orders /></AdminRoute>} />
                <Route path="/admin/devices" element={<AdminRoute auth={auth}><Devices /></AdminRoute>} />
                <Route path="/admin/repairs" element={<AdminRoute auth={auth}><Repairs /></AdminRoute>} />
              </Routes>
            </RepairsProvider>
          </RepairOrdersProvider>
        </DevicesProvider>
